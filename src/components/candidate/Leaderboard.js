...
class Leaderboard extends Component
{
    ...
    handleadd(event){
        console.log(event)
        axios.post("http://localhost:3001/wishlist", event)
        .then(res => {
            console.log(res);
        })
        .catch(err => {
    ...
    render(){
        ...
        const interviewers = this.state.interviewers.map((interviewer) => {
            return(
                    ...
                    <ListGroupItem  onClick={() => this.handleadd(interviewer)} style={{width: '100px', cursor: 'pointer'}}>Add</ListGroupItem>
                    </ListGroup>
            )
        })
        return(
            <div>
                ...
                <div className="container">
                    ...
                    <ListGroupItem style={{width: '100px', backgroundColor: 'blue'}}>Favourite</ListGroupItem>
                    </ListGroup>
                    {interviewers}
                    </ListGroup>
